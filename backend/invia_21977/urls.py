...
admin.site.site_header = "INVIA"
admin.site.site_title = "INVIA Admin Portal"
admin.site.index_title = "INVIA Admin"

# swagger
api_info = openapi.Info(
    title="INVIA API",
    default_version="v1",
    description="API documentation for INVIA App",
)
